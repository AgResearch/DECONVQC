...
%.sample_in_progress/uneak_in_progress:  %.sample_in_progress/uneak_in_progress/kmer_analysis
	# check it looks ok
	echo "checking $@"
...
%.sample_in_progress/uneak_in_progress/kmer_analysis:  %.sample_in_progress/uneak_in_progress/KGD
	...
	/dataset/bioinformatics_dev/active/R3.3/R-3.3.0/bin/Rscript --vanilla  $(GBS_BIN)/kmer_plots_gbs.r datafolder=$</../kmer_analysis
